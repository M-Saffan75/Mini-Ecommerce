...
const OnBoard = ({ navigation }) => {
    ...
    return (
      <>
        ...
        <View style={styles.slide}>
          ...
          <TouchableOpacity activeOpacity={0.6} onPress={() => navigation.navigate('BottomNavigation')} style={{ width: '100%', bottom: 55 }}>
  ...
  const renderDoneButton = () => {
    return (
      <TouchableOpacity activeOpacity={0.6} style={styles.donebtnwrapper} onPress={() => navigation.navigate('BottomNavigation')}>
