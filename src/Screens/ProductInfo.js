...
export default function ProductInfo({ route, navigation }) {
      ...
      const addToCart = async id => {
        ...
        if(itemArray) {
            ...
            try {
                ...
                ToastAndroid.show('Item added Successfully in cart' , ToastAndroid.SHORT);
    ...
    return (
        ...
        <>
            ...
            <View style={{ backgroundColor: COLOURS.white, height: '100%' ,marginTop:40}}>
                <View style={{ height: 330, width: '100%', backgroundColor: COLOURS.backgroundLight, borderBottomRightRadius: 20, borderBottomLeftRadius: 20 }}>
                    <View style={{ marginTop: 20, flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', paddingHorizontal: 20 }}>
                        ...
                        <TouchableOpacity onPress={()=> product.isAvailable ? addToBookmark(product.id) : null}>
                            <Text style={{ backgroundColor: COLOURS.white, height: 40, width: 40, alignItems: 'center', justifyContent: 'center', borderRadius: 5, textAlign: 'center', padding: 8 }}>
                                <Entypo name={'heart-outlined'} style={{ fontSize: 25, color: COLOURS.brown }} />
{/*                                 <Entypo name={'home'} style={{ fontSize: 25, color: COLOURS.brown }} onChange={setData1}/> */}
                ...
                <ScrollView showsVerticalScrollIndicator={false}>
                    ...
                    <View style={{ flexDirection: 'row', alignItems: 'center', marginTop: 20, paddingHorizontal: 20, justifyContent: 'space-between' }}>
                        ...
                        <TouchableOpacity activeOpacity={0.6} style={{flexDirection:'row',justifyContent:'space-between', backgroundColor: COLOURS.brown, height: 30,  borderRadius: 100, alignItems: 'center',
                          padding: 5, }} onPress={()=> navigation.navigate('MapHere')}>
                            <Text style={{color:COLOURS.white,fontSize:12,paddingRight:6,fontFamily:'Poppins-Medium',padding:2}}>Location</Text>
                            <Feather name='map-pin' style={{ fontSize: 10, color: COLOURS.brown,backgroundColor:COLOURS.white,height:20,width:20,borderRadius:100,textAlign:'center',textAlignVertical:'center',}} />
                        </TouchableOpacity>
                    ...
                    <View style={{ marginTop: 20, paddingHorizontal: 20 }}>
                        <Text style={{ color: COLOURS.black, fontSize: 16, fontFamily: 'OpenSans-Bold', letterSpacing: .4,borderLeftWidth:5,borderColor:COLOURS.brown,
                    paddingLeft:15
